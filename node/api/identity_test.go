...
func TestAccountHandler_GetIdentityListHandler(t *testing.T) {
	...
	invoke := func(authID, accountID string) *httptest.ResponseRecorder {
		...
		handlerBase.GetIdentityListHandler(c)
...
func TestPostIdentityHandler(t *testing.T) {
	env := testbase.SetUpTestEnvironment(t)
	defer func() { _ = env.Close() }()
	...
	invoke := func(authID, accountID string, body io.Reader) *httptest.ResponseRecorder {
		...
		handlerBase.PostIdentityHandler(c)
...
func TestAccountHandler_GetIdentityHandler(t *testing.T) {
	env := testbase.SetUpTestEnvironment(t)
	defer func() { _ = env.Close() }()
	...
	invoke := func(authID, accountID, identityHash string) *httptest.ResponseRecorder {
		...
		handlerBase.GetIdentityHandler(c)
